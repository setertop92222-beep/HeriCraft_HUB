-- ============================================
-- HERRICRAFT HUB - СПИСОК СКРИПТОВ (ТЕЛЕФОН)
-- ============================================
...
local function ReturnToDeviceMenu()
    for _, gui in ipairs(CoreGui:GetChildren()) do
        if gui.Name == "HericraftMobileList" then
            gui:Destroy()
        end
    end
...
local function CreateMobileList()
    for _, gui in ipairs(CoreGui:GetChildren()) do
        if gui.Name == "HericraftMobileList" then
            gui:Destroy()
        end
    ...
    screenGui.Name = "HericraftMobileList"
...
print("📱 Список скриптов для телефона загружен!")
CreateMobileList()
